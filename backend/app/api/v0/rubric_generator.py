...
async def save_ontology_draft_endpoint(
    ...
    try:
        result = await save_ontology_draft(
            ...
            user_id=None,  # TODO: Get from auth context when available
        )
        ...
        raise HTTPException(status_code=400, detail={
            "error_type": e.error_type,
            "message_he": e.message_he,
            "errors": [{"location": err.target_id, "message": err.message, "message_he": err.message} for err in e.errors] if hasattr(e.errors[0], 'message') else e.errors,
        })
...
# =============================================================================
# POST-ACCEPTANCE ENHANCEMENT ENDPOINT
# =============================================================================
