...
TERMINALS = [
    ...
    TP("q1.א.c1", 4, [
        ...
        R("q1.א.c1.k2", 2,
          "גוף הבונה משים את שלושת הפרמטרים לתכונות המתאימות",
    ...
    TP("q1.ג.c6", 2, [
        ...
        R("q1.ג.c6.k2", 1, "חישוב ממוצע הספורטיביים והדפסתו",
          "חישוב הממוצע והדפסה (1)"),
        T("q1.ג.c6.k3", 0.5, "החישוב המתמטי של הממוצע נכון",
    ...
    TP("q1.ג.c7", 2, [
        ...
        R("q1.ג.c7.k2", 1, "חישוב ממוצע הלא-ספורטיביים והדפסתו",
          "חישוב הממוצע והדפסה (1)"),
        T("q1.ג.c7.k3", 0.5, "החישוב המתמטי של הממוצע נכון",
          "אם טעו בחישוב מתמטי להוריד 0.5"),
        T("q1.ג.c7.k4", 0.5,
